...
public class CustomerGoogleDto {
	...
	public CustomerGoogleDto() {
	}

	public CustomerGoogleDto(String id, String email, boolean verified_email, String name, String given_name, String family_name, String picture) {
		this.id = id;
		this.email = email;
