<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<footer>
        <div class="section px-32 py-5 bg-gray-900 flex text-white font-medium font-bold justify-between" id="store-address">
            <div class="mr-3 flex flex-col">
                <span class="text-md">Hotline</span>
                <span class="text-sm mb-4">09088889999</span>
                <span class="text-md">Email</span>
                <span class="text-sm mb-4">lightstudio@gmail.com</span>
