	...
	<header class="header">
		<ul class="nav__top flex justify-end bg-gray-300">
			<li><a href="#store-address"
				class="px-4 py-1 block font-bold hover:text-indigo-500 transition-colors">Liên Hệ</a></li>
			<li><a href="#"
				class="px-4 py-1 block font-bold hover:text-indigo-500 transition-colors">Về Chúng Tôi</a></li>
			<!-- 			<li><a href="#"
		...
		<div
			class="nav__bottom flex items-center px-32 bg-gray-300 uppercase">
