	...
	<%@include file="/WEB-INF/views/admin/includes/nav/navbar.jsp"%>
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                <div class="d-block mb-4 mb-md-0">
                    ...
                    <h2 class="h4">Cấu hình sản phẩm</h2>
                    <!-- <p class="mb-0">Trang sản phẩm</p> -->
                </div>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="${applicationScope.addConfigPage }" class="btn btn-sm btn-secondary d-inline-flex align-items-center">
            ...
            <div class="table-settings mb-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <form action = "${applicationScope.configPage }" method="get">
                        <div class="input-group me-2 me-lg-3 fmxw-300">
                            <input type="text" class="form-control" placeholder="Tìm kiếm" name = "search"/>
                        	<a class="input-group-text" href = "${applicationScope.configPage}">
                ...
                <table class="table table-hover">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="border-gray-200">Tên cấu hình</th>
                            <th class="border-gray-200">Màu</th>
                            <th class="border-gray-200">Hình ảnh</th>						
                            <th class="border-gray-200">Loại màn hình</th>
                            <th class="border-gray-200">Kích thước</th>
                            <th class="border-gray-200">Tần số quét</th>
                            <th class="border-gray-200">Độ phân giải</th>
                            <th class="border-gray-200">Tiện ích</th>
                            <th class="border-gray-200">Hệ điều hành</th>
                    ...
                    <tbody>
                        <!-- Item -->
                        <c:forEach items="${pagedListHolder.pageList}" var="config" varStatus="i">
                        <tr>
                            <td>
                                <a href="${applicationScope.configPage}/${config.id}" class="fw-bold">
                                    ${config.id}
                                </a>
                            </td>
                            <td><span class="fw-normal">${config.name}</span></td>
                            <td><span class="fw-normal text-wrap">${config.color}</span></td>
                            <td><img src="${config.image}" width=100 height=100 alt="${config.name}"/></td>
                            <td><span class="fw-normal text-wrap">${config.screentype}</span></td>
                            <td><span class="fw-normal text-wrap">${config.screensize}</span></td>
                            <td><span class="fw-normal text-wrap">${config.scanningfrequency}</span></td>
                            <td><span class="fw-normal text-wrap">${config.resolution}</span></td>
                            <td><span class="fw-normal text-wrap">${config.utilities}</span></td>
                            <td><span class="fw-normal text-wrap">${config.operatingsystem}</span></td>
                            ...
                            <td class = "text-center">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu py-0">
										...
										<a class="dropdown-item rounded-top" href="${applicationScope.configPage}/${config.id}">
										<i class="bi bi-eye-fill dropdown-icon text-gray-400 me-2 icon-sm"></i>
										Chi tiết</a>
                                    
                                        
                                        <a class="dropdown-item text-warning" href="${applicationScope.configPage}/edit/${config.id}">
	                                        <i class="bi bi-pencil-square dropdown-icon me-2"></i>
	                                        Chỉnh sửa
                                        </a>
                                        
                                        <a id="btnDelete" class="dropdown-item text-danger rounded-bottom" data-bs-toggle="modal" data-bs-target="#modal-warning" data-id="${config.id}">
