    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="${applicationScope.dashboardPage }" class="nav-link d-flex align-items-center">
                    ...
                    <span class="mt-1 ms-1 sidebar-text fst-italic  fw-bolder">LightStudio</span>
                </a>
            </li>
        ...
        <div class="multi-level collapse "
          ...
          <ul class="flex-column nav">
            ...
            <!-- Supplier Manager -->
            <li class="nav-item">
                <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#subsupplier-pages">
                    <span>
                        <span class="sidebar-icon">
                ...
                <div class="multi-level collapse" role="list" id="subsupplier-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link" href="${applicationScope.supplierPage}">
                                <span class="sidebar-text">Quản Lý</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${applicationScope.addSupplierPage}">
                                <span class="sidebar-text">Thêm nhà cung cấp</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <!-- Disscount Manager -->
            <li class="nav-item">
                <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#subdisscount-pages">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                        </span>
                        <span class="sidebar-text">Khuyến mãi</span>
                    </span>
                    <span class="link-arrow">
                        <svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                ...
                <div class="multi-level collapse" role="list" id="subdisscount-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link" href="${applicationScope.disscountPage}">
                                <span class="sidebar-text">Quản Lý</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${applicationScope.addDisscountPage}">
                                <span class="sidebar-text">Thêm khuyến mãi</span>
                            </a>
                        </li>
                    </ul>
                </div>
